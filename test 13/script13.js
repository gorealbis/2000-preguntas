// BANCO DE PREGUNTAS DEL TEST 13 (Preguntas 1 a 20: Higiene, úlceras, cura húmeda y constantes)
const questions = [
    ...
    { id: 4, pregunta: "El baño de asiento consiste en:", opciones: ["a. La inmersión de la parte comprendida entre la zona media del muslo y la cresta ilíaca en agua a una temperatura de 43-46°C", "b. Inmersión del cuerpo en agua a 35-38°C, a la que se le añaden sustancias sedantes", "c. Inmersión del cuerpo en agua a 35-38°C, a la que se le añaden sustancias suavizantes de acción local", "d. By c son correctas"], correcta: 0 },
    ...
    { id: 17, pregunta: "La cura húmeda consiste en:", opciones: ["a. Cubrir la herida con sustancias que favorecen la limpieza natural de la herida de las sustancias exudativas", "b. Limpieza de arrastre exhaustiva con suero fisiológico", "c. Evitar alergias, humedad y maceración de la piel", "d. No existe dicho tipo de cura"], correcta: 0 },
    ...
    { id: 25, pregunta: "A la hora de la toma de temperatura rectal, ¿cuál de las siguientes afirmaciones no es correcta?", opciones: ["a. Hay que esperar tres minutos para realizar la lectura de la temperatura rectal", "b. La temperatura rectal disminuye 0,5°C del valor tomado en la axila", "c. Hay que esperar seis-siete minutos para tomar la temperatura axilar", "d. En la toma de temperatura rectal, hay que descender el mercurio por debajo de 36°C"], correcta: 1 },
    ...
    { id: 52, pregunta: "La sonda de Foley hay que cambiarla cada:", opciones: ["a. 30 días", "b. 15 días", "c. 8-10 días", "d. Diariamente"], correcta: 1 },
    ...
    { id: 60, pregunta: "Las glándulas que vierten su contenido directamente a los capilares sanguíneos se denominan:", opciones: ["a. Exocrinas", "b. Endocrinas", "c. Pancreáticas", "d. by c"], correcta: 1 },
    ...
    { id: 73, pregunta: "Conducto a través del cual la vesícula expulsa la bilis al duodeno:", opciones: ["a. Esfínter de Oddi", "b. Cístico", "c. Conducto vesicular", "d. Conducto pancreático"], correcta: 1 },
    ...
    { id: 76, pregunta: "La insulina es segregada por:", opciones: ["a. Las células β del páncreas", "b. Las células α del páncreas", "c. Las células α y β del páncreas", "d. Ninguna es correcta"], correcta: 0 },
    ...
    { id: 79, pregunta: "El páncreas segrega:", opciones: ["a. Insulina y glucagón", "b. Amilasa y lipasa", "c. Tripsina-quimotripsina", "d. Todas son correctas"], correcta: 3 },
    ...
    { id: 81, pregunta: "La hectasa y la sacarasa son segregadas por:", opciones: ["a. El hígado", "b. El páncreas", "c. El estómago", "d. Las células de la mucosa intestinal"], correcta: 3 },
